...
import useNgrokApiKey from './hooks/useNgrokApiKey'; // Correctly import the hook
...
const NgrokKeyInput: React.FC<NgrokKeyInputProps> = ({ setApiKey }) => {
  ...
  const { validateApiKey, loading, error } = useNgrokApiKey({ onSuccess });
